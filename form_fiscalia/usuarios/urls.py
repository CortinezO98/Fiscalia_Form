...
urlpatterns = [
    ...
    path('abogado/', views.dashboard_abogado, name='dashboard_abogado'),
    path('abogado/casos/', views.mis_casos_abogado, name='mis_casos_abogado'),
    path('abogado/caso/<int:caso_id>/', views.detalle_caso_abogado, name='detalle_caso_abogado'),
    path('abogado/buscar/', views.buscar_casos_abogado, name='buscar_casos_abogado'),
